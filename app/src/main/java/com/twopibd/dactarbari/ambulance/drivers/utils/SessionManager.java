...
public class SessionManager {
    ...
    public void setCurrency(String usename) {
        prefs.edit().putString("currency", usename).commit();
    }

    public String getCurrency() {
        String id = prefs.getString("currency", "USD");
        return id;
    }
    ...
    public void setAlarmData(String nid) {
        prefs.edit().putString("alarmData", nid).commit();
    }

    public String getAlarmData() {
        String nid = prefs.getString("alarmData", "");
        return nid;
    }

    public void setSecondaryUserId(String nid) {
        prefs.edit().putString("SecondaryUserId", nid).commit();
    }

    public String getSecondaryUserId() {
        String nid = prefs.getString("SecondaryUserId", "");
        return nid;
    }
    ...
    public void setOnlineVehicle(String usename) {
        prefs.edit().putString("onlineVehicle", usename).commit();
    }

    public String getOnlineVehicle() {
        String id = prefs.getString("onlineVehicle", "");
        return id;
    }
}